...
//#ifdef SWAP_GPIO27_TO_GPIO26
	...
	enum ToZero_4x_GPIO
	{
		...
		GPIO_22 = 16,           
		//3V3
		GPIO_10 = 11,	//PI SPI0 MOSI
		GPIO_9 = 12,	//PI SPI0 MISO
		GPIO_11 = 13,	//PI SPI0 SCK
		//GND
	...
	#endif
		//GND
		GPIO_12 = 6,	//PI PWM0   //Was 23  
		//GND
	#ifndef SWAP_GPIO16_TO_CE1
		GPIO_16 = 9,	//On solder selector with CE1
	#endif
		GPIO_20 = 8,	//PI PCM_DIN
		GPIO_21 = 7,	//PI PCM_DOUT
	};
